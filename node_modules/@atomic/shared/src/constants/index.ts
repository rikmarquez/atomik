...
export const API_ENDPOINTS = {
  ...
  IDENTITY_AREAS: {
    ...
    UPDATE: (id: string) => `/api/v1/identity-areas/${id}`,
    DELETE: (id: string) => `/api/v1/identity-areas/${id}`,
    GET: (id: string) => `/api/v1/identity-areas/${id}`
  },
  SYSTEMS: {
    LIST: '/api/v1/systems',
    CREATE: '/api/v1/systems',
    UPDATE: (id: string) => `/api/v1/systems/${id}`,
    DELETE: (id: string) => `/api/v1/systems/${id}`,
    GET: (id: string) => `/api/v1/systems/${id}`,
    EXECUTE: (id: string) => `/api/v1/systems/${id}/execute`
  },
  EXECUTIONS: {
    LIST: '/api/v1/executions',
    GET: (id: string) => `/api/v1/executions/${id}`,
    DELETE: (id: string) => `/api/v1/executions/${id}`
  },
